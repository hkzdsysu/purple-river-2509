...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-river-2509)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/purple-river-2509
```

A live public deployment of this template is available at [https://purple-river-2509.templates.workers.dev](https://purple-river-2509.templates.workers.dev)
